...
describe('CandidateDetailsComponent', () => {
  ...
  let mockcandidateService: any, mockroute, mockstatusService, mockexcelService,
    mockstatusdata, mockcandidatedata: any, mockexceldata:any,mockuserData:any,
    mockMatSnackBar:any
  ...
  beforeEach(() => {
    mockcandidateService = jasmine.createSpyObj('CandidateService', ['PostCandidateDuplicateCheck', 'GetAllCandidatesData', 'PostCandidateData', 'DeleteCandidateData', 'UpdateCandidateData',
      ...
      mockMatSelect=jasmine.createSpyObj('MatSelect',['close'])
    ...
    mockexcelService = jasmine.createSpyObj('ExcelService', ['jsonExportAsExcel','jsonExportAsExcelExperiment'])
    mockMatSnackBar=jasmine.createSpyObj('MatSnackBar',['open'])
    TestBed.configureTestingModule({
      declarations: [CandidateDetailsComponent,CapitalizeFirstLetterPipe],
    ...
    mockexcelService.jsonExportAsExcelExperiment.and.returnValue(of(mockexceldata))
  ...
  it('onOptionClick',()=>{
     const colum="Select All"
     spyOn(component,'handleAdvancedViewChange')
     component.onOptionClick(colum,mockMatSelect)
  })
  it('onOptionClick',()=>{
    const colum=""
    spyOn(component,'AddColumns')
    component.onOptionClick(colum,mockMatSelect)
 })
